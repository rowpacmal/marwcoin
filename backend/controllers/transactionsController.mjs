...
export const getTransactionByHash = (req, res, next) => {
    try {
        ...
        const transaction = blockchain?.chain
...
export const getTransactionsInBlock = (req, res, next) => {
    try {
        ...
        const block = blockchain?.chain?.find(block => +block.index === +blockIndex);
...
export const createTransaction = (req, res, next) => {
    try {
        ...
        if (!sender || !receiver || !payload) {
            return sendResponse(res, 'Missing or invalid fields. Expected `sender`, `receiver`, and `payload`', 400);
        }
