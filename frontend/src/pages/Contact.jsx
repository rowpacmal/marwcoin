      ...
      <div className={contactCSS.container}>
        <div className="box">
          <div className={contactCSS.title_container}>
            <h2 className={contactCSS.title}>Please contact us at MARW.</h2>
            <h2 className={contactCSS.title}>We would love to hear from you.</h2>
          </div>
          <ul>
            <li>
            ...
            <li>
              <i className="fa fa-location-pin" aria-hidden="true"></i>
              <span>12 Tarnished Way, Limgrave, ER1 3NG, Lands Between</span>
            </li>
          </ul>
        </div>
          ...
          <div className={contactCSS.box_r}>
            <div className={contactCSS.form_box}>
              ...
              <form action="" method="post">
                ...
                <button className={contactCSS.btn_send}>Contact us</button>
              </form>
            </div>
          </div>
        </div>
